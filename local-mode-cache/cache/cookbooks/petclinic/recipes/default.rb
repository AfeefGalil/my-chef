...
remote_file '/Users/afeefaz/Desktop/Chef/afeef_petclinic/cookbooks/petclinic/petclinic.jar' do
...
execute 'run_jar' do
  command 'java -jar /Users/afeefaz/Desktop/Chef/afeef_petclinic/cookbooks/petclinic/petclinic.jar &'
  action :run
end